...
setup(
    ...
    install_requires=['flowable.external-worker-client>=1.0.1rc4'],
    extras_require={
        'testing': ['pytest', 'vcrpy', 'flowable.external-worker-client>=1.0.1rc4', 'robocorp-actions>=0.2.1', 'robocorp-tasks>=3.1.1', 'robocorp-truststore>=0.9.1', 'rpaframework']
    },
)
